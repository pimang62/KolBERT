...
class RAGPretrainedModel:
    ...
    def _process_metadata(
        self,
        document_ids: Optional[Union[TypeVar("T"), List[TypeVar("T")]]],  # type: ignore
    ...
    def index(
        self,
        collection: list[str],
        document_ids: Union[TypeVar("T"), List[TypeVar("T")]] = None,  # type: ignore
    ...
    def add_to_index(
        ...
        new_document_ids: Optional[Union[TypeVar("T"), List[TypeVar("T")]]] = None,  # type: ignore
